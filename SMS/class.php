              ...
              <form role="form" method="POST">
                <div class="box-body">
                  ...
                  <div class="form-group">
                    ...
                    <input name="hno" type="text" class="form-control" id="exampleInputPassword1"
                      placeholder="Enter Class Room ID" required>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input name="title" type="text" class="form-control" id="exampleInputPassword1"
                      placeholder="Enter Class Room Title" required>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input name="location" type="text" class="form-control" id="exampleInputPassword1"
                      placeholder="Enter Class Room Location" required>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Capacity</label>
                    <input name="capacity" type="text" class="form-control" id="exampleInputPassword1"
                      placeholder="Enter Class Room Capacity" required>
                  </div>
