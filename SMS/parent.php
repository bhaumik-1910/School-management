                ...
                <form role="form" method="POST">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <input name="nic" type="text" class="form-control" id="exampleInputPassword1"
                        placeholder="Enter Parent NIC" required>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input name="contact" type="text" class="form-control" id="exampleInputPassword1"
                        placeholder="Enter Parent Contact No" required>
                    </div>

                    <div class="form-group">
                      <label for="exampleInputPassword1">Occupation</label>
                      <input name="job" type="text" class="form-control" id="exampleInputPassword1"
                        placeholder="Enter Parent Occupation" required>
                    </div>
              ...
              <div class="box box-primary">
                ...
                <form role="form" method="POST">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      <label for="exampleInputPassword1">Contact</label>
                      <input name="contact" type="text" class="form-control" id="exampleInputPassword1" required
