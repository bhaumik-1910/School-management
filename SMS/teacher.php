                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group date">
                        ...
                        <input type="text" name='dob' class="form-control pull-right" id="datepicker"
                          placeholder="Select Teacher's Data of Birth">
                      </div>
                      <!-- /.input group -->
              ...
              <div class="box box-primary">
                ...
                <form role="form" method="POST">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      <label for="exampleInputPassword1">Teacher ID</label>
                      <input name="sid" type="text" class="form-control" id="exampleInputPassword1" readonly value=<?php echo "'" . $tid . "'"; ?>>
                    </div>
