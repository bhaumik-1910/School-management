              ...
              <form role="form" method="POST">
                <div class="box-body">
                  ...
                  <div class="form-group">
                    ...
                    <input name="sid" type="text" class="form-control" id="exampleInputPassword1" disabled="disabled"
...
if (isset($_POST['submitatt'])) {
  ...
  foreach ($_POST['att'] as $key => $value) {
    ...
    $attendance = $conn->prepare("INSERT INTO attendancereport (aid,sid,status) VALUES (?, ?, ?)");
    $attendance->bind_param("iss", $aid, $key, $value);
    $attendance->execute();
